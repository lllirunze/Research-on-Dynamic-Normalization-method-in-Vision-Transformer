...
class DTN(nn.Module):
    ...
    def forward(self, input):
        ...
        # gn_input.shape: B x T x heads x (C/heads)
        ...
        # Note: 这里设定 patch_size(P) = resolution(H or W), 且 H == W
        # Positional attention.shape: [B, heads, H, W]
